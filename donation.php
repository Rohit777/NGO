...
<div class="container" style="padding-top:3%; padding-bottom: 3%;" >
    ...
    <div style="text-align:center;">
        <h3 style="color:#8c2a00; font-weight:540;">Contact</h3>
        <h4>Operation Office</h4>
        <div>
            <p>
            H.No-1359, Ground Floor, Block-E<br>
            Jahangir Puri, Delhi-110033<br>
            Phone:- +011 27634206<br>
            E-mail- kanshiramwelfarefoundation@gmail.com<br>
            Web link- kanshiramfoundation.org
            </p>
        </div>
    </div>
    <p style="padding:8px 0px; border:2px solid #8c2a00; text-align:center;">To <span style="color:#8c2a00; font-weight: bold">DONATE</span> please contact the above address</p>
</div>
