...
<head>
    ...
    <title>AWARDS    |Kanshiram Welfare Foundation</title>
...
<div class="container" style="padding-top:3%; padding-bottom: 3%;" >
    <p>
    Kanshiram Welfare Foundation is a registered Organisation and has a valid 80G and 12A certificate.
    Donations to foundation are exempt from income tax under Section 80G of the Income Tax Act,
    1961.
    </p>
    <div style="text-align:center;">
        <h3 style="color:#8c2a00; font-weight:540;">Bank Details</h3>
        <div>
            <p>
            National Urban Cooperative Bank LTD.<br>
            New Kondli Mayur Vihar Phase III, Branch, Delhi-110096<br>
            A/C No-00201110106195<br>
            Branch Code- UTIB0S<br>
            IFSC Code- UTIB0SNUC01<br>
            MICR Code- 110211251<br>
            </p>
        </div>
    </div>
    <p style="padding:8px 0px; border:2px solid #8c2a00; text-align:center;">To <span style="color:#8c2a00; font-weight: bold">DONATE - </span>Cheque/ IMPS/NEFT/RTGS may be considered.</p>
</div>
